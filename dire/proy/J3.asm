...
fila1:
    ...
    jg saltoA      
        ...
        f1c1:
            cmp cx,125
            jg f1c2
            BACKGRAUND Amarillo,L1_inicio,L1_fin,C1_inicio,C1_fin
			BACKGRAUND Amarillo,L4_inicio,L4_fin,C1_inicio,C1_fin
			TONO 587
            jmp escucha
        saltoA: 
            jmp fila2
        ...
        f1c2:
            cmp cx,250
            jg f1c3
            BACKGRAUND Violeta,L1_inicio,L1_fin,C2_inicio,C2_fin
			BACKGRAUND Violeta,L4_inicio,L4_fin,C4_inicio,C4_fin
			 TONO 622
            jmp escucha   
        ...
        f1c3:
            cmp cx,370
            jg f1c4
            BACKGRAUND Rozado,L1_inicio,L1_fin,C3_inicio,C3_fin
        ...
        f1c4:
			...
			BACKGRAUND Celeste,L3_inicio,L3_fin,C1_inicio,C1_fin
			TONO 698
            jmp escucha  
        f1c5:
            cmp cx,610
            jg escucha1
            BACKGRAUND Azul,L1_inicio,L1_fin,C5_inicio,C5_fin
			BACKGRAUND Azul,L4_inicio,L4_fin,C3_inicio,C3_fin
			TONO 740
            jmp escucha
        escucha1:
            jmp escucha
...
fila2:
    ...
    jg saltoB
        ...
        f2c1:
			...
			BACKGRAUND Cafe,L4_inicio,L4_fin,C5_inicio,C5_fin
			TONO 784 
            jmp escucha
		saltoB: 
            jmp fila3
        ...
        f2c2:
            cmp cx,250
            jg f2c3
            BACKGRAUND Morado,L2_inicio,L2_fin,C2_inicio,C2_fin
			BACKGRAUND Morado,L3_inicio,L3_fin,C4_inicio,C4_fin
			TONO 830
            jmp escucha   
        ...
        f2c3:
            cmp cx,370
            jg f2c4
            BACKGRAUND Rojo,L2_inicio,L2_fin,C3_inicio,C3_fin
			BACKGRAUND Rojo,L3_inicio,L3_fin,C2_inicio,C2_fin
			TONO 880
            jmp escucha
        ...
        f2c4:
            cmp cx,490
            jg f2c5
            BACKGRAUND Acua,L2_inicio,L2_fin,C4_inicio,C4_fin
			BACKGRAUND Acua,L3_inicio,L3_fin,C3_inicio,C3_fin
			TONO 823
            jmp escucha  
        f2c5:
            cmp cx,610
            jg escha2
            BACKGRAUND Otro,L2_inicio,L2_fin,C5_inicio,C5_fin
